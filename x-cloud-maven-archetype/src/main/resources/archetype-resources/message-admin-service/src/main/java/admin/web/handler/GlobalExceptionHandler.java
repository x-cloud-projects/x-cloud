...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.admin.web.handler;
...
import com.xfeel.boot.autoconfigure.validator.BaseLocaleExceptionHandler;
...
@Slf4j
public class GlobalExceptionHandler extends BaseLocaleExceptionHandler {
